...
struct globals_misc     *ash_ptr_to_globals_misc = NULL;
struct globals_memstack *ash_ptr_to_globals_memstack = NULL;
struct globals_var      *ash_ptr_to_globals_var = NULL;
